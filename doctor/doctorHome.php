<?php
session_start();  // Start the session for managing doctor login

// Check if the doctor is already logged in
if (isset($_SESSION['dr_id'])) {
    // Redirect to the dashboard or another page if the doctor is logged in
...
<body>
    ...
    <div class="main-container">
        <div class="welcome-box">
            ...
            <h1>Welcome to PetHug Veterinary Hospital</h1>
            <p>Already a member? <a href="doctorLogin.php">Log In</a></p>
            <p>New here? <a href="doctor_signup.php">Create a New Account</a></p>
            <div>
                <a href="doctorLogin.php" class="action-btn">Log In to Your Account</a>
                <a href="doctor_signup.php" class="action-btn">Join Us Today</a>
            </div>
        </div>
    </div>
