...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM doctor WHERE dr_email = '$email'";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $doctor['dr_password'])) {
            ...
            header("Location:../doctor/doctor_dashboard.php"); // Redirect to user home page
            exit();
        } else {
...
<body>
  <div class="container">
    ...
    <div class="left-section">
      ...
      <p class="signup-link">Don't have an account? <a href="doctor_signup.php">Sign Up</a></p>
    </div>
